...
USAGE
    .\Renamer.ps1 [-Path <directory>] [-Start <string>] [-End <string>] 
                  [-Delete <string>] [-Remove] [-Ext <extension>] [-WhatIf]

PARAMETERS

    -Path <string>
        Specifies the directory containing files to rename.
        If not provided, a file selection dialog will open.
        Example: -Path "C:\MyFiles"

    -Start <string>
        String to add at the beginning of filenames.
        When used with -Remove, removes this string from the beginning instead.
        Example: -Start "backup_"

    -End <string>
        String to add at the end of filenames (before extension).
        When used with -Remove, removes this string from the end instead.
        Example: -End "_v2"

    -Delete <string>
        String to remove from anywhere in filenames.
        Can be used with -Ext, but NOT with -Start or -End.
        Example: -Delete "temp"

    -Remove
        Switch that changes behavior from "add" to "remove" when used with -Start or -End.
        Example: -Start "old_" -Remove
...
EXAMPLES
    ...
    .\Renamer.ps1 -Path "C:\Files" -Start "backup_"

    # Add suffix to selected files (opens dialog)
    .\Renamer.ps1 -End "_final"

    # Remove prefix and change extension
    .\Renamer.ps1 -Path "C:\Files" -Start "old_" -Remove -Ext new

    # Remove string from anywhere and change extension
    .\Renamer.ps1 -Delete "draft" -Ext final

    # Combine multiple operations
    .\Renamer.ps1 -Start "prod_" -End "_v3" -Ext zip

    # Preview changes before applying
    .\Renamer.ps1 -Path "C:\Files" -Start "new_" -WhatIf
...
Write-Host "`nFile Renamer Tool v4.1" -ForegroundColor Cyan

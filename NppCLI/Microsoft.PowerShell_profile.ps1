...
Set-PSReadLineOption -ShowToolTips -HistoryNoDuplicates -MaximumHistoryCount 3000
Set-PSReadLineOption -PredictionSource HistoryAndPlugin -PredictionViewStyle ListView


function Show-HistoryTop {
    param([int]$Count=50)
    Get-History | Select-Object -Last $Count | Format-Table -AutoSize
}
Set-Alias hist Show-HistoryTop
...
# Aliases for Files & Directories as function 
